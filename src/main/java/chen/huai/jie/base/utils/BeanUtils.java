...
public class BeanUtils extends org.apache.commons.beanutils.BeanUtils {
	...
	public static void copyBeanNotNull2Bean(Object databean, Object tobean) throws Exception {
		...
		for (int i = 0; i < origDescriptors.length; i++) {
			...
			if (PropertyUtils.isReadable(databean, name)&& PropertyUtils.isWriteable(tobean, name)) {//保证可读可写
				try {
	 ...
	 * @throws InvocationTargetException
	 */
	public static void copyMap2Bean(Map<String,Object> properties,Object bean)
			throws IllegalAccessException, InvocationTargetException {
		...
		while (names.hasNext()) {
			...
			try {
				Class clazz = PropertyUtils.getPropertyType(bean, name);//获取字段类型
				if (null == clazz) {
					continue;
				}
				String className = clazz.getName();//获取字段类型名
	 ...
	 * @throws InvocationTargetException
	 */
	public static void copyMap2Bean_Nobig(Map properties,Object bean)
			throws IllegalAccessException, InvocationTargetException {
		// Do nothing unless both arguments have been specified
		if ((bean == null) || (properties == null)) {
			return;
