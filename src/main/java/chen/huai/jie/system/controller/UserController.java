...
public class UserController extends BaseController {
	...
	public void mofifyUser(UserEntity entity, String roles, HttpServletResponse response) {
		...
		userEntity.setUser_login_name(entity.getUser_login_name());
		userEntity.setUser_name(entity.getUser_name());
		userEntity.setOrgan_code(entity.getOrgan_code());
		userEntity.setOrgan_name(entity.getOrgan_name());
