...
public class SysLogController extends BaseController implements SysLogIController {
    @Resource
    ...
    public void exportUserList(LogPager pager, HttpServletResponse response) throws IOException {
        ...
        for (LogEntity logEntity : list) {
            ...
            try {
                ...
                logBeanForExport.setCreate_time(DateFormatUtils.format(logEntity.getCreateTime(), "yyyy-MM-dd HH:mm:ss"));
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        Workbook workbook = excelUtil.doExportExcel1(wk, sheetTitle, headerList, logBeanForExportList, pattern, 0, false);
