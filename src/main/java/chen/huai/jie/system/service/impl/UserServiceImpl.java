...
public class UserServiceImpl implements UserService {
     ...
     */
    @Override
    public List<Map<String, UserEntity>> findAllUsers() {
        List<Map<String, UserEntity>> list = new ArrayList<Map<String, UserEntity>>();
        List<UserEntity> users = userDAO.findAllUsers();
        for (UserEntity userEntity : users) {
            Map<String, UserEntity> user = new HashMap<String, UserEntity>();
